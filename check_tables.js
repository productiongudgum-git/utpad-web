...
const tablesToCheck = [
  'ops_events', 'ops_workers', 'ops_worker_module_access',
  'recipe_ingredients', 'recipe_definitions', 'recipe_lines', 'flavor_definitions'
];
...
(async () => {
  console.log('Checking actual tables used in api/index.js...\n');
